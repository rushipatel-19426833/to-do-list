...
window.onload = function () {
    ...
    // when there is data in the list the clear button will appear
    ...
    // this statement will hide the clear button when there is no task in the list
    if (localStorage.length <= 0) {
        btnClr.style.display = "none"; //hide clear btn	
    ...
    function addTodoItem() {
        // if the user doesn't input any vaulue the user will get an alert
        if (input.value === "") {
